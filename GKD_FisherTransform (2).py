...
class GKD_FisherTransform(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            (dataframe["fisher_6h"] < self.fisher_sell_threshold.value) & 
            (dataframe["fisher_smooth_6h"] < dataframe['fisher_6h']), # &
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
            (dataframe["fisher_smooth_6h"].shift() > 0) & 
            (dataframe["fisher_smooth_6h"] < 0) & 
            (dataframe["fisher_smooth_6h"] > dataframe['fisher_6h'])
